...
interface ImageUploadRepository {
    ...
    /**
     * 방 커버 배경 이미지를 업로드하고, 커버 저장에 사용할 공개 URL 을 돌려준다.
     *
     * @param imageUri 갤러리에서 선택한 이미지의 content URI 문자열
     */
    suspend fun uploadRoomCoverImage(imageUri: String): ChallaResult<String>
